...
SceneType.ChainFront	= 21 -- 历战试炼-连锁战线 -- v 5.2
...
eDuplicateType.ChainFront      = 20 -- 历战试炼-连锁战线 -- v 5.2
eDuplicateType.EternalBattle   = 21 -- 永境战域 -- v 5.3
eDuplicateType.SkinPass   	   = 22 -- 皮肤通行证 -- v 5.3
...
ePassiveTiming.OnTransform       = 28  -- 变身
