...
function SetViewLayout(openSetting)
    ...
    elseif openSetting==TeamOpenSetting.PVP then
		...
		CSAPI.SetGOActive(btn_list,selectType==TeamSelectType.Normal and true or false);
		hasPrefab = false
    elseif openSetting==TeamOpenSetting.PVE or openSetting==TeamOpenSetting.Tower or openSetting==TeamOpenSetting.Rogue or openSetting==TeamOpenSetting.TotalBattle or openSetting==TeamOpenSetting.RogueS or openSetting==TeamOpenSetting.Colosseum or openSetting==TeamOpenSetting.RogueT or openSetting==TeamOpenSetting.MultBattle or openSetting==TeamOpenSetting.PVPMirror or openSetting==TeamOpenSetting.TowerDeep or openSetting==TeamOpenSetting.Trials2 or openSetting==TeamOpenSetting.SkinPass then
		CSAPI.SetGOActive(btn_svType2,canAssist);
        CSAPI.SetGOActive(viewType,true);
		CSAPI.SetGOActive(btn_list,false);
    end
	if openSetting==TeamOpenSetting.Tower or openSetting==TeamOpenSetting.Rogue or openSetting==TeamOpenSetting.TotalBattle or openSetting==TeamOpenSetting.RogueS or openSetting==TeamOpenSetting.Colosseum or openSetting==TeamOpenSetting.RogueT or openSetting==TeamOpenSetting.MultBattle or openSetting==TeamOpenSetting.TowerDeep or openSetting==TeamOpenSetting.Trials2 then
		hasPrefab=false;
	end
