...
function SetTitleIcon()
    ...
    elseif sceneType == SceneType.GlobalBoss or sceneType == SceneType.TowerDeep or sceneType == SceneType.ChainFront then
        imgName = "end"
    elseif sceneType == SceneType.PVPMirror or IsPvpSceneType(sceneType) then
...
function SetPVEPanel()
    ...
    if dungeonType == eDuplicateType.Tower then
        ...
        return
    elseif dungeonType == eDuplicateType.NewTower or (cfgDungeon and cfgDungeon.type == eDuplicateType.EternalBattle) then
...
function TryAgain()
    ...
    elseif sceneType == SceneType.ChainFront then
        ...
        dialogData.okCallBack = function()
            FightClient:Clean()
            FightProto:EnterChainFrontFight(elseData.round, CloseParent)
        end
    end
