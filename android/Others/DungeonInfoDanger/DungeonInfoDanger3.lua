...
function Awake()
    ...
    if layout then
        layout:Init("UIs/DungeonActivity2/DungeonDangerNum3", LayoutCallBack, true)
...
function SetTips(_str)
    CSAPI.SetText(txt_tip,_str)
end
...
function SetClick(b,str)
    CSAPI.SetGOActive(clickMask,b)
    tips = str or ""
end
