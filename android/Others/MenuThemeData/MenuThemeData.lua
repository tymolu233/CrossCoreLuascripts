...
function this:GetName()
    return self.cfg.name or ""
end

-- 描述
function this:GetDesc()
    return self.cfg.desc or ""
end

-- 获取途径 
function this:GetPath()
    return self.cfg.jumpid
end

function this:GetQuality()
    return self.cfg.quality or 1
end
...
function this:CheckNeedShow(needGet)
    if (needGet) then
