...
function Buffer4780210:OnCreate(caster, target)
	...
	-- 4780210
	self:AddAttr(BufferEffect[4780210], self.caster, self.card, nil, "attack",math.floor(c771*100*10))
	-- 8771
	local c771 = SkillApi:GetAttr(self, self.caster, target or self.owner,3,"crit")
	-- 4780220
	self:AddAttr(BufferEffect[4780220], self.caster, self.creater, nil, "attack",math.floor(c771*100*10))
end
