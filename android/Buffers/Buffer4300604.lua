...
---------------------------------------------
-- 技能基类
Buffer4300604 = oo.class(BuffBase)
function Buffer4300604:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer4300604:OnActionOver(caster, target)
	-- 8160
	...
	-- 4300604
	self:AddBuffCount(BufferEffect[4300604], self.caster, self.creater, nil, 4300619,math.floor((1-c5+0.00001)*10),100)
end
