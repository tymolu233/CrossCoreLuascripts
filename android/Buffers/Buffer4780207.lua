...
---------------------------------------------
-- 技能基类
Buffer4780207 = oo.class(BuffBase)
function Buffer4780207:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 伤害前
function Buffer4780207:OnBefourHurt(caster, target)
	-- 4780222
	self:tFunc_4780222_4780224(caster, target)
	self:tFunc_4780222_4780226(caster, target)
end
-- 创建时
function Buffer4780207:OnCreate(caster, target)
	-- 8771
...
function Buffer4780207:tFunc_4780222_4780226(caster, target)
	-- 8060
