...
---------------------------------------------
-- 技能基类
Buffer303000202 = oo.class(BuffBase)
function Buffer303000202:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer303000202:OnRoundBegin(caster, target)
	-- 6107
...
-- 行动结束
function Buffer303000202:OnActionOver(caster, target)
	-- 8060
