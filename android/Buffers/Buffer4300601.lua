...
---------------------------------------------
-- 技能基类
Buffer4300601 = oo.class(BuffBase)
function Buffer4300601:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer4300601:OnActionOver(caster, target)
	-- 8160
	...
	-- 4300601
	self:AddBuffCount(BufferEffect[4300601], self.caster, self.creater, nil, 4300616,math.floor((1-c5+0.00001)*10),100)
end
