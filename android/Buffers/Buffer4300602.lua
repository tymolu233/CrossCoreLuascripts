...
---------------------------------------------
-- 技能基类
Buffer4300602 = oo.class(BuffBase)
function Buffer4300602:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer4300602:OnActionOver(caster, target)
	-- 8160
	...
	-- 4300602
	self:AddBuffCount(BufferEffect[4300602], self.caster, self.creater, nil, 4300617,math.floor((1-c5+0.00001)*10),100)
end
