...
{delay=680,time=4000,type=3,hit_creates={1192467788},hits={0}},
...
{time=4000,type=1,hit_type=0,camera_shake={time=330,shake_dir=1,range=200,hz=200,decay_value=0.45},hit_creates={1349028111},hits={950,1350}},
