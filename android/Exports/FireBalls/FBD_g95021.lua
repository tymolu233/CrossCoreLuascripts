...
{effect="cast2_hit",time=3000,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/Eighteen.acb",cue_name="95020_cast_03"},
...
[-1609092943]={
{delay=1000,time=4000,type=1,hit_type=1,camera_shake={time=150,shake_dir=1,range=300,range2=300,hz=10,decay_value=0.6},hits={0,300}},
{effect="cast0_hit",time=4000,type=0,pos_ref={ref_type=6}},
