...
{effect="cast2_hit",time=4000,type=0,pos_ref={ref_type=6},path_target={ref_type=3,offset_row=-100}},
{effect="cast2_eff",time=4500,type=0,pos_ref={ref_type=3,offset_row=100},cue_sheet="fight/effect/twelfth.acb",cue_name="Ice_strength_attack_skill_02"},
