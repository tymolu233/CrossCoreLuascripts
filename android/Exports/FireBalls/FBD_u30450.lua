...
{effect="cast1_eff",time=3500,type=0,pos_ref={ref_type=6},cue_sheet="cv/Leedsichthys.acb",cue_name="Leedsichthys_10",cue_feature=1},
...
{effect="cast0_eff",time=3500,type=0,pos_ref={ref_type=6},cue_sheet="cv/Leedsichthys.acb",cue_name="Leedsichthys_09",cue_feature=1,path_target={ref_type=1}},
