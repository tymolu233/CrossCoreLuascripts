...
GameMsg.map["FightProto:GetChainFrontInfoRet"] = {
	--活动id 最高分     最近一次各怪物关卡分数 
	{ "uint","uint",    "list|sPairIntInt",   },
	{ "id",  "maxScore","dupScore",           },
}
...
GameMsg.map["PlayerProto:GetRankRet"] = {
	--排名数据         我的排名 排行榜类型（章节id） 当前积分 下次刷新时间        回合数     排行榜奖励数据 
	{ "list|sStarRank","int",   "int",               "string","int",              "uint",    "json",        },
	{ "data",          "rank",  "rank_type",         "score", "next_refresh_time","turn_num","reward_issue",},
}
