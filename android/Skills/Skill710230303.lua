...
---------------------------------------------
-- 技能基类
Skill710230303 = oo.class(SkillBase)
function Skill710230303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill710230303:DoSkill(caster, target, data)
	-- 13047
...
-- 行动结束
function Skill710230303:OnActionOver(caster, target, data)
	-- 8200
