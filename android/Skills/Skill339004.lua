...
---------------------------------------------
-- 技能基类
Skill339004 = oo.class(SkillBase)
function Skill339004:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill339004:OnAttackOver(caster, target, data)
	-- 8063
	...
	-- 339004
	self:Cure(SkillEffect[339004], caster, target, data, 6,0.04)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	...
	if self:Rand(4000) then
		self:AddBuff(SkillEffect[339009], caster, target, data, 304500200+count755)
	end
end
