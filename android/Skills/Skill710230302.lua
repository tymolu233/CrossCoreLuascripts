...
---------------------------------------------
-- 技能基类
Skill710230302 = oo.class(SkillBase)
function Skill710230302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill710230302:DoSkill(caster, target, data)
	-- 13047
...
-- 行动结束
function Skill710230302:OnActionOver(caster, target, data)
	-- 8200
