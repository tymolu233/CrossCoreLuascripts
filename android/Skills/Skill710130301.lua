...
---------------------------------------------
-- 技能基类
Skill710130301 = oo.class(SkillBase)
function Skill710130301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill710130301:DoSkill(caster, target, data)
	-- 13039
...
-- 行动结束
function Skill710130301:OnActionOver(caster, target, data)
	-- 8200
