...
---------------------------------------------
-- 技能基类
Skill5800009 = oo.class(SkillBase)
function Skill5800009:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill5800009:OnAfterHurt(caster, target, data)
	-- 4503043
	self:tFunc_4503043_4503003(caster, target, data)
	self:tFunc_4503043_4503033(caster, target, data)
end
-- 伤害前
function Skill5800009:OnBefourHurt(caster, target, data)
	-- 4503063
	self:tFunc_4503063_4503013(caster, target, data)
	self:tFunc_4503063_4503053(caster, target, data)
end
-- 暴击伤害前(OnBefourHurt之前)
function Skill5800009:OnBefourCritHurt(caster, target, data)
	-- 8062
...
function Skill5800009:tFunc_4503043_4503003(caster, target, data)
	-- 8060
...
function Skill5800009:tFunc_4503063_4503053(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill5800009:tFunc_4503043_4503033(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill5800009:tFunc_4503063_4503013(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
