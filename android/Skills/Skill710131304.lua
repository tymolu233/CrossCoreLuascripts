...
---------------------------------------------
-- 技能基类
Skill710131304 = oo.class(SkillBase)
function Skill710131304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill710131304:DoSkill(caster, target, data)
	-- 13039
...
-- 行动结束
function Skill710131304:OnActionOver(caster, target, data)
	-- 8200
