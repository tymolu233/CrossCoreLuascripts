...
function Skill403901305:OnBefourCritHurt(caster, target, data)
	...
	-- 403901305
	self:AddTempAttr(SkillEffect[403901305], caster, self.card, data, "crit_rate",0.5)
	-- 8464
	local count64 = SkillApi:GetAttr(self, caster, target,3,"crit_rate")
	-- 403901310
	self:AddTempAttr(SkillEffect[403901310], caster, self.card, data, "damage",math.max((count64-1),0)*1.5)
	-- 8464
	local count64 = SkillApi:GetAttr(self, caster, target,3,"crit_rate")
	-- 8966
	...
	-- 403901315
	self:AddTempAttr(SkillEffect[403901315], caster, self.card, data, "damage",math.max((count64-1),0)*1.5)
end
