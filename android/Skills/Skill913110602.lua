...
---------------------------------------------
-- 技能基类
Skill913110602 = oo.class(SkillBase)
function Skill913110602:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill913110602:OnBefourHurt(caster, target, data)
	-- 8060
	...
	-- 913110603
	self:AddTempAttr(SkillEffect[913110603], caster, self.card, data, "damage",math.min((count7-count8)*0.006,1))
end
-- 行动结束
function Skill913110602:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 入场时
function Skill913110602:OnBorn(caster, target, data)
	-- 913110808
