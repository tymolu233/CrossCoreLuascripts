...
---------------------------------------------
-- 技能基类
Skill339901 = oo.class(SkillBase)
function Skill339901:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill339901:OnBefourHurt(caster, target, data)
	-- 8062
	...
	-- 339901
	self:AddTempAttr(SkillEffect[339901], caster, caster, data, "damage",0.04)
end
