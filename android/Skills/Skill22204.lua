...
---------------------------------------------
-- 技能基类
Skill22204 = oo.class(SkillBase)
function Skill22204:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill22204:OnBefourHurt(caster, target, data)
	-- 22243
...
function Skill22204:tFunc_22243_22213(caster, target, data)
	-- 8060
...
function Skill22204:tFunc_22243_22253(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill22204:tFunc_22243_22233(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill22204:tFunc_22243_22223(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill22204:tFunc_22243_22263(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill22204:tFunc_22243_22203(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
