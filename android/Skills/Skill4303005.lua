...
---------------------------------------------
-- 技能基类
Skill4303005 = oo.class(SkillBase)
function Skill4303005:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 拉条时
function Skill4303005:OnAddProgress(caster, target, data)
	-- 8071
...
-- 行动结束
function Skill4303005:OnActionOver(caster, target, data)
	-- 8062
...
-- 回合结束时
function Skill4303005:OnRoundOver(caster, target, data)
	-- 8062
	if SkillJudger:CasterIsTeammate(self, caster, target, true) then
	else
		return
...
function Skill4303005:tFunc_4303013_4303014(caster, target, data)
	-- 4303015
...
function Skill4303005:tFunc_4303013_4303009(caster, target, data)
	-- 4303009
