...
---------------------------------------------
-- 技能基类
Skill339904 = oo.class(SkillBase)
function Skill339904:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill339904:OnBefourHurt(caster, target, data)
	-- 8062
	...
	-- 339904
	self:AddTempAttr(SkillEffect[339904], caster, caster, data, "damage",0.16)
end
