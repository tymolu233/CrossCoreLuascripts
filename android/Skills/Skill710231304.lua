...
---------------------------------------------
-- 技能基类
Skill710231304 = oo.class(SkillBase)
function Skill710231304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill710231304:DoSkill(caster, target, data)
	-- 13047
...
-- 行动结束
function Skill710231304:OnActionOver(caster, target, data)
	-- 8200
