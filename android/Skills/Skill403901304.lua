...
function Skill403901304:OnBefourCritHurt(caster, target, data)
	...
	-- 403901304
	self:AddTempAttr(SkillEffect[403901304], caster, self.card, data, "crit_rate",0.4)
	-- 8464
	local count64 = SkillApi:GetAttr(self, caster, target,3,"crit_rate")
	-- 403901309
	self:AddTempAttr(SkillEffect[403901309], caster, self.card, data, "damage",math.max((count64-1),0)*1.5)
	-- 8464
	local count64 = SkillApi:GetAttr(self, caster, target,3,"crit_rate")
	-- 8966
	...
	-- 403901314
	self:AddTempAttr(SkillEffect[403901314], caster, self.card, data, "damage",math.max((count64-1),0)*1.5)
end
