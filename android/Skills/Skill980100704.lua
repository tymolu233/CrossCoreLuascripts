...
---------------------------------------------
-- 技能基类
Skill980100704 = oo.class(SkillBase)
function Skill980100704:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 加buff时
function Skill980100704:OnAddBuff(caster, target, data, buffer)
	-- 8063
	...
	-- 980100722
	self:AddBuffCount(SkillEffect[980100722], caster, self.card, data, 980100701,1,10)
end
-- 行动结束2
function Skill980100704:OnActionOver2(caster, target, data)
	-- 8654
	...
	-- 980100719
	self:AddBuffCount(SkillEffect[980100719], caster, self.card, data, 980100701,-10,10)
	-- 980100720
