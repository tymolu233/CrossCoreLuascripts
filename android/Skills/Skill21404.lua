...
---------------------------------------------
-- 技能基类
Skill21404 = oo.class(SkillBase)
function Skill21404:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill21404:OnBefourHurt(caster, target, data)
	-- 8063
...
-- 行动开始
function Skill21404:OnActionBegin(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
