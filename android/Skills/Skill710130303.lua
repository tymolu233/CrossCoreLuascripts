...
---------------------------------------------
-- 技能基类
Skill710130303 = oo.class(SkillBase)
function Skill710130303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill710130303:DoSkill(caster, target, data)
	-- 13039
...
-- 行动结束
function Skill710130303:OnActionOver(caster, target, data)
	-- 8200
