...
---------------------------------------------
-- 技能基类
Skill20504 = oo.class(SkillBase)
function Skill20504:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill20504:OnBefourHurt(caster, target, data)
	-- 20523
	self:tFunc_20523_20503(caster, target, data)
	self:tFunc_20523_20513(caster, target, data)
end
function Skill20504:tFunc_20523_20513(caster, target, data)
	-- 8166
...
function Skill20504:tFunc_20523_20503(caster, target, data)
	-- 8060
