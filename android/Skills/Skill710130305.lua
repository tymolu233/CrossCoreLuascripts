...
---------------------------------------------
-- 技能基类
Skill710130305 = oo.class(SkillBase)
function Skill710130305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill710130305:DoSkill(caster, target, data)
	-- 13039
...
-- 行动结束
function Skill710130305:OnActionOver(caster, target, data)
	-- 8200
