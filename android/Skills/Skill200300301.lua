...
---------------------------------------------
-- 技能基类
Skill200300301 = oo.class(SkillBase)
function Skill200300301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill200300301:DoSkill(caster, target, data)
	-- 12003
...
-- 行动开始
function Skill200300301:OnActionBegin(caster, target, data)
	-- 8200
...
-- 行动结束
function Skill200300301:OnActionOver(caster, target, data)
	-- 8200
	if SkillJudger:IsCurrSkill(self, caster, target, true) then
	else
		return
...
-- 行动结束2
function Skill200300301:OnActionOver2(caster, target, data)
	-- 8200
	if SkillJudger:IsCurrSkill(self, caster, target, true) then
	else
		return
