...
---------------------------------------------
-- 技能基类
Skill980100703 = oo.class(SkillBase)
function Skill980100703:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 加buff时
function Skill980100703:OnAddBuff(caster, target, data, buffer)
	-- 8063
...
-- 行动结束2
function Skill980100703:OnActionOver2(caster, target, data)
	-- 8654
