...
function Skill403901301:OnBefourCritHurt(caster, target, data)
	...
	-- 403901301
	self:AddTempAttr(SkillEffect[403901301], caster, self.card, data, "crit_rate",0.1)
	-- 8464
	local count64 = SkillApi:GetAttr(self, caster, target,3,"crit_rate")
	-- 403901306
	self:AddTempAttr(SkillEffect[403901306], caster, self.card, data, "damage",math.max((count64-1),0)*1.5)
	-- 8464
	local count64 = SkillApi:GetAttr(self, caster, target,3,"crit_rate")
	-- 8966
	...
	-- 403901311
	self:AddTempAttr(SkillEffect[403901311], caster, self.card, data, "damage",math.max((count64-1),0)*1.5)
end
