...
---------------------------------------------
-- 技能基类
Skill339404 = oo.class(SkillBase)
function Skill339404:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill339404:OnBorn(caster, target, data)
	-- 8060
...
-- 伤害后
function Skill339404:OnAfterHurt(caster, target, data)
	-- 8070
...
-- 回合开始处理完成后
function Skill339404:OnAfterRoundBegin(caster, target, data)
	-- 8420
	local count20 = SkillApi:GetAttr(self, caster, target,3,"hp")
	-- 8106
	if SkillJudger:Less(self, caster, self.card, true,count20,2) then
