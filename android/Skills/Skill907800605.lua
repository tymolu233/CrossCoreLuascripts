...
---------------------------------------------
-- 技能基类
Skill907800605 = oo.class(SkillBase)
function Skill907800605:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill907800605:OnRoundOver(caster, target, data)
	-- 907800607
	...
	-- 907800611
	self:AddBuff(SkillEffect[907800611], caster, self.card, data, 907800606)
end
