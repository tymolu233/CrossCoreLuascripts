...
---------------------------------------------
-- 技能基类
Skill339002 = oo.class(SkillBase)
function Skill339002:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill339002:OnAttackOver(caster, target, data)
	-- 8063
	...
	-- 339002
	self:Cure(SkillEffect[339002], caster, target, data, 6,0.02)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	...
	if self:Rand(2000) then
		self:AddBuff(SkillEffect[339007], caster, target, data, 304500200+count755)
	end
end
