...
---------------------------------------------
-- 技能基类
Skill710230304 = oo.class(SkillBase)
function Skill710230304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill710230304:DoSkill(caster, target, data)
	-- 13047
...
-- 行动结束
function Skill710230304:OnActionOver(caster, target, data)
	-- 8200
