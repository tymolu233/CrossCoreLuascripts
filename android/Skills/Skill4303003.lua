...
---------------------------------------------
-- 技能基类
Skill4303003 = oo.class(SkillBase)
function Skill4303003:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 拉条时
function Skill4303003:OnAddProgress(caster, target, data)
	-- 8071
...
-- 行动结束
function Skill4303003:OnActionOver(caster, target, data)
	-- 8062
...
-- 回合结束时
function Skill4303003:OnRoundOver(caster, target, data)
	-- 8062
	if SkillJudger:CasterIsTeammate(self, caster, target, true) then
	else
		return
	...
	-- 4303004
	if SkillJudger:Greater(self, caster, target, true,count772,6) then
	else
		return
	end
	-- 4303007
	self:AddBuffCount(SkillEffect[4303007], caster, self.card, data, 4303002,-7,999)
	-- 4303013
	self:tFunc_4303013_4303014(caster, target, data)
	self:tFunc_4303013_4303009(caster, target, data)
end
function Skill4303003:tFunc_4303013_4303014(caster, target, data)
	-- 4303015
...
function Skill4303003:tFunc_4303013_4303009(caster, target, data)
	-- 4303009
