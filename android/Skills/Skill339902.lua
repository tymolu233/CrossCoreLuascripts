...
---------------------------------------------
-- 技能基类
Skill339902 = oo.class(SkillBase)
function Skill339902:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill339902:OnBefourHurt(caster, target, data)
	-- 8062
	...
	-- 339902
	self:AddTempAttr(SkillEffect[339902], caster, caster, data, "damage",0.08)
end
