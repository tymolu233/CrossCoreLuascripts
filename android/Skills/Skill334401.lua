...
function Skill334401:OnBefourHurt(caster, target, data)
	...
	-- 334401
	self:AddTempAttr(SkillEffect[334401], caster, caster, data, "damage",math.floor(count7/10)*0.004)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	...
	-- 334406
	self:AddTempAttr(SkillEffect[334406], caster, caster, data, "damage",math.floor(count7/10)*0.004)
end
