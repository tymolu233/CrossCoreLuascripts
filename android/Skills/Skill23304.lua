...
---------------------------------------------
-- 技能基类
Skill23304 = oo.class(SkillBase)
function Skill23304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill23304:OnBefourHurt(caster, target, data)
	-- 23343
	self:tFunc_23343_23303(caster, target, data)
	self:tFunc_23343_23313(caster, target, data)
end
-- 行动结束
function Skill23304:OnActionOver(caster, target, data)
	-- 23336
	self:tFunc_23336_23334(caster, target, data)
	self:tFunc_23336_23335(caster, target, data)
end
function Skill23304:tFunc_23343_23313(caster, target, data)
	-- 8166
...
function Skill23304:tFunc_23336_23335(caster, target, data)
	-- 8749
	local count749 = SkillApi:GetNP(self, caster, target,3)
	-- 8964
	if SkillJudger:Greater(self, caster, self.card, true,count749,40) then
...
function Skill23304:tFunc_23336_23334(caster, target, data)
	-- 8749
	local count749 = SkillApi:GetNP(self, caster, target,3)
	-- 8964
	if SkillJudger:Greater(self, caster, self.card, true,count749,40) then
...
function Skill23304:tFunc_23343_23303(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
